...
const replaceClientCreation = (j, source, { v2ClientName, v2ClientLocalName, v2GlobalName, v3ClientName }) => {
    ...
    source
        ...
        .replaceWith((v2ClientNewExpression) => (0, getNewClientExpression_1.getNewClientExpression)(j, clientName, v2ClientNewExpression));
    if (v2GlobalName) {
        source
